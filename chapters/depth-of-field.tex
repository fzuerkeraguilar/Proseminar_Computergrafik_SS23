...
The main advantage of this method is the ability to perform the necessary calculations in parallel for each pixel and therefore maximising the performance of modern rendering hardware.

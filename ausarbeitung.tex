...
\newcommand{\mytitle}{Blurring images in real-time}
...
To increase immersiveness and artistic control of these application it is critical to also recreate the flaws of the human eye or camera systems.
However, a realistic simulation of the optical system of a camera is currently outside the scope of real-time images.
In this work we explore a range of techniques to approximate the motion blur and depth of field effects caused by a real camera system.
We give an overview over the underlying phenomena causing these artefacts and compare various techniques in their approximation of these phenomena and their performance.
